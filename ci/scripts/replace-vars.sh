...
sed dp-dd-file-uploader/appspec.yml dp-dd-file-uploader/scripts/codedeploy/* -i \
...
cp dp-dd-file-uploader/appspec.yml artifacts/
cp dp-dd-file-uploader/scripts/codedeploy/* artifacts/scripts/codedeploy
